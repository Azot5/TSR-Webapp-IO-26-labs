...
class ConfigReader:
    ...
    def _load_config(self):
        try:
            ...
            # Database files
            self.USER_DB_FILE = self._get_config_value(root, "USER_DB_FILE")
            self.ADMIN_DB_FILE = self._get_config_value(root, "ADMIN_DB_FILE")
            self.QUEUE_DB_FILE = self._get_config_value(root, "QUEUE_DB_FILE")
            self.VACCINE_DB_FILE = self._get_config_value(root, "VACCINE_DB_FILE")
